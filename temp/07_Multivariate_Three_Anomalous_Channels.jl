...
# WICMAD: Multivariate Three Anomalous Channels Experiment
# This script runs WICMAD on the Multivariate Three Anomalous Channels simulated dataset.
...
# ============================================================================
# Experiment: Multivariate Three Anomalous Channels
# ============================================================================
...
function run_simulated_experiment(anomaly_type, dataset_name; is_multivariate=false, regime=nothing)
    ...
    for mc_idx in 1:mc_trials
        ...
        println("  Functional depths computed. Starting WICMAD...")
