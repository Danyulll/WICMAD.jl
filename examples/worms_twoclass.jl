...
println("Loading WormsTwoClass dataset (combining TRAIN + TEST)...")
ds_loaded = load_ucr_dataset("WormsTwoClass/WormsTwoClass", data_dir)
...
plots_dir = joinpath(dirname(@__DIR__), "plots", "worms_twoclass")
mkpath(plots_dir)
