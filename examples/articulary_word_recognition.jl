...
using WICMAD
using WICMAD.Utils: load_ucr_dataset, prepare_anomaly_dataset, summarize_dataset
...
println("Loading ArticularyWordRecognition dataset (combining TRAIN + TEST)...")
ds_loaded = load_ucr_dataset("ArticularyWordRecognition/ArticularyWordRecognition", data_dir)
...
# Interpolate each series to 32 time points
...
plots_dir = joinpath(dirname(@__DIR__), "plots", "articulary_word_recognition")
mkpath(plots_dir)
