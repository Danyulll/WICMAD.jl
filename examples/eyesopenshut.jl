...
println("Loading EyesOpenShut dataset (combining TRAIN + TEST)...")
ds_loaded = load_ucr_dataset("EyesOpenShut (1)/EyesOpenShut", data_dir)
...
plots_dir = joinpath(dirname(@__DIR__), "plots", "eyesopenshut")
mkpath(plots_dir)
