...
println("Loading UWaveGestureLibrary dataset (combining TRAIN + TEST)...")
ds_loaded = load_ucr_dataset("UWaveGestureLibrary/UWaveGestureLibrary", data_dir)
...
plots_dir = joinpath(dirname(@__DIR__), "plots", "uwavegesturelibrary")
mkpath(plots_dir)
