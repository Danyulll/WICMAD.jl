...
println("Loading AbnormalHeartbeat dataset (combining TRAIN + TEST)...")
ds_loaded = load_ucr_dataset("AbnormalHeartbeat/AbnormalHeartbeat", data_dir)
...
plots_dir = joinpath(dirname(@__DIR__), "plots", "abnormalheartbeat")
mkpath(plots_dir)
