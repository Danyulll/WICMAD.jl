...
println("Loading Epilepsy dataset (combining TRAIN + TEST)...")
ds_loaded = load_ucr_dataset("Epilepsy/Epilepsy", data_dir)
...
plots_dir = joinpath(dirname(@__DIR__), "plots", "epilepsy")
mkpath(plots_dir)
