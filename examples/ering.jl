...
println("Loading ERing dataset (combining TRAIN + TEST)...")
ds_loaded = load_ucr_dataset("ERing/ERing", data_dir)
...
# Interpolate each multivariate series to 32 time points
...
plots_dir = joinpath(dirname(@__DIR__), "plots", "ering")
mkpath(plots_dir)
