...
println("Loading Chinatown dataset (combining TRAIN + TEST)...")
ds_loaded = WICMAD.Utils.load_ucr_dataset("Chinatown/Chinatown", data_dir)
...
plot_series_by_labels(X, gt_binary; title_str="RAW - Ground Truth (blue=normal, red=anomaly)", filepath=joinpath(plots_dir, "chinatown_raw_ground_truth.png"))
pred_bin_raw_map = to_binary_labels(z_final_raw)
plot_series_by_labels(X, pred_bin_raw_map; title_str="RAW - MAP prediction", filepath=joinpath(plots_dir, "chinatown_raw_after_map.png"))
...
plot_series_by_labels(X, pred_bin_raw_dahl; title_str="RAW - Dahl consensus prediction", filepath=joinpath(plots_dir, "chinatown_raw_after_dahl.png"))
plot_series_by_labels(X, pred_bin_raw_f1; title_str="RAW - F1-max prediction", filepath=joinpath(plots_dir, "chinatown_raw_after_f1.png"))
...
plot_multi_channel_stacked(Y_d1, gt_binary; title_str="RAW+D1 - Ground Truth", filepath=joinpath(plots_dir, "chinatown_raw_d1_ground_truth.png"))
pred_bin_d1_map = to_binary_labels(z_final_d1)
plot_multi_channel_stacked(Y_d1, pred_bin_d1_map; title_str="RAW+D1 - MAP prediction", filepath=joinpath(plots_dir, "chinatown_raw_d1_after_map.png"))
...
plot_multi_channel_stacked(Y_d1, pred_bin_d1_dahl; title_str="RAW+D1 - Dahl consensus prediction", filepath=joinpath(plots_dir, "chinatown_raw_d1_after_dahl.png"))
plot_multi_channel_stacked(Y_d1, pred_bin_d1_f1; title_str="RAW+D1 - F1-max prediction", filepath=joinpath(plots_dir, "chinatown_raw_d1_after_f1.png"))
...
plot_multi_channel_stacked(Y_d12, gt_binary; title_str="RAW+D1+D2 - Ground Truth", filepath=joinpath(plots_dir, "chinatown_raw_d12_ground_truth.png"))
pred_bin_d12_map = to_binary_labels(z_final_d12)
plot_multi_channel_stacked(Y_d12, pred_bin_d12_map; title_str="RAW+D1+D2 - MAP prediction", filepath=joinpath(plots_dir, "chinatown_raw_d12_after_map.png"))
...
plot_multi_channel_stacked(Y_d12, pred_bin_d12_dahl; title_str="RAW+D1+D2 - Dahl consensus prediction", filepath=joinpath(plots_dir, "chinatown_raw_d12_after_dahl.png"))
plot_multi_channel_stacked(Y_d12, pred_bin_d12_f1; title_str="RAW+D1+D2 - F1-max prediction", filepath=joinpath(plots_dir, "chinatown_raw_d12_after_f1.png"))
